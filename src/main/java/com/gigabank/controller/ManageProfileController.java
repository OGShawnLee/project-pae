...
public class ManageProfileController extends ManageController<EmployeeDTO> {
  @FXML
  ...
  public void initialize(EmployeeDTO currentUser) {
    ...
    loadObjectDataFields(currentUser);
  }
  ...
  protected void handleManage() {
    try {
      ...
      Modal.displaySuccess("El perfil ha sido actualizado con éxito.");
